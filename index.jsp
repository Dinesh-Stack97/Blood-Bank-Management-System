...
<body>
  ...
  {
	  %>
	  <center><font color="red" size ="5">Form Submitted Successfully...You will get Notified within 8 or 24 Hours..!</font></center>
	  <% 
  }
  %>
   <%
  ...
  {
	  %>
	  <center><font color="red" size ="5">Form Submission Fail...You can Retry!</font></center>
	  <% 
  }
  %>
...
<Center><button class="button"><span>Submit</span></button>
</center> 
